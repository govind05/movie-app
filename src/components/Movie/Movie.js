...
import { addToWatched, onUserRating } from '../../store/actions/watched';
...
class Movie extends React.Component {
  render() {
    ...
    const watched = this.props.watched.filter(
      movie => movie.title === this.props.title
    ).length;
    // Finding the searched movie from the list of watched movies.
    const movie = this.props.watched.find(
      movie => movie.title === this.props.title
    );
        ...
        <div>
          ...
          <div>
            ...
            >
              ...
              {watched ? <div className="Watched">Watched</div> : null}
            </div>
              ...
              <div>
                <span>
                  <MdThumbUp
                    ...
                    size={30}
                    onClick={() =>
                      this.props.onUserRating('upvote', this.props.title)
                    }
                  />
                </span>
                <span>
                  <MdThumbDown
                    ...
                    size={30}
                    onClick={() =>
                      this.props.onUserRating('downvote', this.props.title)
                    }
                  />
                </span>
              </div>
...
const mapDispatchToProps = dispatch => ({
  ...
  onUserRating: (rating, title) => dispatch(onUserRating(rating, title)),
});
